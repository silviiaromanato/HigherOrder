...
if __name__ == '__main__':   
    for movie_name in os.listdir(PATH_MOVIES):
        ...
        clip.audio.write_audiofile("/media/miplab-nas2/Data2/Movies_Emo/Silvia/Data/Audio/audioYouAgain.wav")
        filename = "/media/miplab-nas2/Data2/Movies_Emo/Silvia/Data/Audio/audioYouAgain.wav"
        ...
        plt.hist(s_energy)
        plt.savefig('/media/miplab-nas2/Data2/Movies_Emo/Silvia/Data/Output/energy_sound.png')
